...
if(isset($_POST['update'])){
  $npass= $_POST['npass'];
      ...
      $cpass=$_POST['cpass'];
        $opass=$_POST['opass'];
        if($npass==""||$cpass==""||$opass=="")
{
   echo "<script>alert('Enter all fields');</script>";
}
  $sql ="SELECT * from patient_login where emailid = '$id' ";
...
if($npass==$cpass){
        ...
        $sql=mysqli_query($conn,"UPDATE patient_login set cpassword ='$cpass' where emailid ='$id'");
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="Patient_dashboard.php"><i class="fa fa-home back-icon"></i> <span>Back to Home</span></a>
                        </li>
                        ...
                        <form action="" method="post">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" placeholder="Enter Old Password" name="opass" class="form-control" autofocus="" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="password-field" name="npass" placeholder="Enter New Password" class="form-control" autofocus="" required="">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-center m-t-20">
                                    <button type="submit" name="update" class="btn btn-primary submit-btn">Update Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
