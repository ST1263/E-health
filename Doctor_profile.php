...
$conn = mysqli_connect("$dbhost", "$dbusername", "$dbpass", "$dbname");
 $id = $_SESSION['id'];
  $sql ="SELECT * from doctor_profile where emailid = '$id'";  
                $result = mysqli_query($conn,$sql);

                $queryresult = mysqli_num_rows($result);
                if($queryresult > 0){
                 while ($row = mysqli_fetch_assoc($result)) { 
                    $doctor_no=$row['doctor_no'];
 
 }
}           
else{
$query = "SELECT * from doctor_profile order by doctor_no desc limit 1";
...
$lastid = $row['doctor_no'];

  $doctor_no = substr($lastid,1);
  $doctor_no = intval($doctor_no);
  $doctor_no = "D".($doctor_no+01);
  //$z=date('yy-m-d');
}
}
else
...
$id = $_SESSION['id'];
          ...
          if (mysqli_num_rows($res) > 0) {
            ...
            $new_img_name=$images['dprofile_img'];

                //echo $dlname1;

            $sql="UPDATE doctor_profile SET dprofile_img='$new_img_name',dname='$dname',dlname='$dlname',doctor_no='$doctor_no',gender='$gender',hname='$hname',address='$address',state='$state',country='$country',pincode='$pincode',phone='$phone',haddress='$haddress',experiance='$experiance',grade='$grade',doctor_no='$doctor_no',specialization='$specialization',degree='$degree',dob='$dob',fee='$fee',name='$name' WHERE  emailid ='$id'";
...
//echo $img;
        ...
        // $sql=mysqli_query($conn,"UPDATE  patient_profile set  name ='$fname',surname ='$lname',emailid ='$emailid',profile_img='$new_img_name' where emailid ='$id'");
                      ...
                      $sql="INSERT INTO doctor_profile(dprofile_img,emailid,dname,dlname,doctor_no,gender,haddress,address,state,country,pincode,phone,hname,experiance,degree,grade,specialization,dob,fee,name
                    ) VALUES ('$new_img_name','$id','$dname','$dlname','$doctor_no','$gender','$haddress','$address','$state','$country','$pincode','$phone','$hname','$experiance','$degree','$grade','$specialization','$dob','$fee','$name')";                                   
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                       ...
                       <!--  <li>
                        ...
                        <!-- <li>
                            <a href="edit-appointment.php"><i class="fa fa-calendar"></i> <span>Appointments</span></a>
                        </li> -->
                        <!-- <li>
...
$id = $_SESSION['id'];
          $sql = "SELECT dprofile_img FROM doctor_profile where emailid='$id'";
          $res = mysqli_query($conn,  $sql);

          if (mysqli_num_rows($res) > 0) {
          	while ($images = mysqli_fetch_assoc($res)) { 
            $img=$images['dprofile_img'];

             ?>
             
            <div class="alb">
             	<img style="margin-left:-8%; width:115%;" src="uploads/<?=$images['dprofile_img']?>">
    ...
    <?php } }?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-focus">
                                                ...
                                                <input type="text" name="doctor_no" value="<?php echo @$doctor_no;?>" class="form-control floating" value="" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">First Name</label>
                                                <input type="text" name="dname" value="<?php echo @$dname;?>" class="form-control floating" value="" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">Last Name</label>
                                                <input type="text" name="dlname" value="<?php echo @$dlname;?>" class="form-control floating" value="Doe" required>
                  ...
                  <input class="upload" name="my_image" id="img" type="file" >
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <input type="text" name="degree" class="form-control floating" value="<?php echo @$degree;?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">Experance</label>
                                    <input type="text" name="experiance" class="form-control floating" value="<?php echo @$experiance;?>" required>
                                </div>
                            </div>
                           <!--  <div class="col-md-6">
                                <div class="form-group form-focus">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <input type="text" name="ephone" class="form-control floating" value="<?php echo @$ephone;?>">
                                </div>
                            </div> -->
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">Grade</label>
                                    <input type="text" class="form-control floating" name="grade" value="<?php echo @$grade;?>" required>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="add-more">
                    ...
                    <div class="card-box">
                        <h3 class="card-title">Hosptal Informations</h3>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <input type="text" name="specialization" class="form-control floating" value="<?php echo @$specialization;?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">Hospital Name</label>
                                    <input type="text" name="hname" class="form-control floating" value="<?php echo @$hname;?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <label class="focus-label">Hospital Address</label>
                                    <input type="text" name="haddress" class="form-control floating" value="<?php echo @$haddress;?>" required>
                                </div>
                            ...
                            <div class="col-md-6">
                            	<div class="form-group form-focus">
                                    <label class="focus-label">Consantancy Fee</label>
                                    <input type="text" name="fee" class="form-control floating" value="<?php echo @$fee;?>" required>
                                </div>
