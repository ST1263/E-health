...
$aid=$_GET['aid'];
  ...
  $result=mysqli_query($conn,"SELECT * FROM appointment where aid = '$aid' ");
...
echo '<div class="row col-11 ">';
 ...
 echo '<div class="form-group">';
   ...
   echo '<b><label>' .'Doctor Name:&nbsp;&nbsp'.'</b></label>';
   echo '<span>'  .$row['dname'].'</span>';  
   echo '</div>'; 
   echo '</div>';
    echo ' <div class="col-md-6">';
    echo '<div class="form-group">';
   echo '<b><label>' .'Patient Name:&nbsp&nbsp;'.'</b></label>';
echo '<span>' .$row['pname'].'</span>';
 ...
 echo '<div class="form-group">';
   ...
   echo '<b><label>' .'Date:&nbsp&nbsp;'.'</b></label>';
   echo '<span>'  .$row['date'].'</span>';  
   echo '</div>'; 
   echo '</div>';
    echo ' <div class="col-md-6">';
    echo '<div class="form-group">';
   echo '<b><label>' .'Doctor Email:&nbsp&nbsp;'.'</b></label>';
echo '<span>' .$row['demail'].'</span>';
 echo '</div>';echo '</div>';
 echo '</div>';
...
$aid=$_GET['aid'];
  ...
  $result=mysqli_query($conn,"SELECT * FROM prescription where aid = '$aid' ");
