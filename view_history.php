            ...
            <div class="content">   
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                                        <label></label>
                                        <input type="text" placeholder="Enter file no" name="fileno" class="form-control">
...
$fileno=$_POST['fileno'];
  $result=mysqli_query($conn,"SELECT * FROM information where fileno = '$fileno' ");
...
while($row=mysqli_fetch_array($result) )
{
    ...
    $result1=mysqli_query($conn,"SELECT * FROM prescription where emailid = '$emailid' AND demail = '$id' ");
...
//$status=$row['status'];
echo '<tr>';
   echo '<td name="aid"><Strong class="aid">'.$row1['aid'].'</Strong></td>';
   echo '<td>'  .$row1['bp'].'</td>';
   echo '<td>' .$row1['sugar'].'</td>';
   echo '<td>' .$row1['temprature'].'</td>';
   echo '<td>' .$row1['prescription'].'</td>';
...
/*$demail=$row['emailid'];*/
   ...
   /* $_SESSION['aid']=$aid; */  
      ...
      $msg=$_POST['msg'];
      $status=$_POST['status'];*/
            $sql=mysqli_query($conn,"INSERT INTO prescription(aid,bp,sugar,temprature,prescription,dname,emailid) VALUES ('$aid','$bp','$suger','$temprature','$prescription','$dname','$emailid')");
         echo "string";
                 if ( $sql)
                   {
