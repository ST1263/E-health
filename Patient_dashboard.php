...
#
$ret1="SELECT * FROM appointment where emailid='$id' AND status='Approved' ";
$result1 = mysqli_query($conn,$ret1);
  ...
  while($row = mysqli_fetch_assoc($result1))
{
  ...
  if ($date==$bookingdate) {
    ...
    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"><i class="fa fa-bell-o"></i> <span class="badge badge-pill bg-danger float-right"><?php echo $queryresult;?></span></a>
  ...
  echo '<td class="text-right">';
                                           echo '<div class="dropdown dropdown-action">';
                                               ...
                                               echo ' <div class="dropdown-menu dropdown-menu-right">';
                                                   /*echo '<a class="dropdown-item" href="edit-appointment.html"><i class="fa fa-pencil m-r-5"></i> Edit</a>';*/

                                                   echo '<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_appointment"><i class="fa fa-trash-o m-r-5"></i> Delete</a>';
                                                   echo '<a class="dropdown-item" href="view_prescription.php?aid='.$row["aid"].'"><i class="fa fa-pencil m-r-5"></i>View Prescription</a>';
