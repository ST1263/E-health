...
if($npass==$cpass){
        ...
        $sql=mysqli_query($conn,"UPDATE login set cpassword ='$cpass' where emailid ='$id'");
    ...
    <div class="main-wrapper">
        <div class="header">
			<div class="header-left">
				<a href="Doctor_dashboard.php.php" class="logo">
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="Doctor_dashboard.php"><i class="fa fa-home back-icon"></i> <span>Back to Home</span></a>
                        </li>
