...
if(isset($_POST['update'])){
 /* $dname=$_POST['dname'];
$query = "SELECT * from doctor_profile where dname = '$dname'";
$result = mysqli_query($conn,$query);
//$row = mysqli_fetch_array($result);
$queryresult = mysqli_num_rows($result);
...
$demail=$row['emailid'];
    ...
    $aid=$_POST['aid'];   
      ...
      $msg=$_POST['msg'];
   */   $status=$_POST['status'];
            /*$sql=mysqli_query($conn,"INSERT INTO appointment(dept,dname,aid,pname,date,time,emailid,phone,msg,status,demail) VALUES ('$dept','$dname','$aid','$name','$date','$time','$id','$phone','$msg','$status','$demail')");*/
         $sql=mysqli_query($conn,"UPDATE appointment SET status='$status' where aid='$aid'");
                 if ( $sql)
                   {

                      echo "";
                       
                      echo "'<script> alert('Status Updated'); window.location.href='Doctor_dashboard.php'; </script>'";
    ...
    <div class="main-wrapper">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										...
										<input class="form-control" value="<?php echo @$aid;?>" name="aid" type="text" value="" readonly>
									</div>
                                </div>
                                <div class="col-md-6">
									<div class="form-group">
										<label>Patient Name</label>
                                        <input class="form-control" name="pname" value="<?php echo @$name;?>" type="text" name="pname" value="" readonly>
	 ...
	 -->									<!-- <select class="select">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="pname" value="<?php echo @$dept;?>" type="text" name="pname" value="" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Doctor</label>
                                        <input class="form-control" name="pname" value="<?php echo @$dname;?>" type="text" name="pname" value="" readonly>
                                        <!-- <select class="select" name="dname" id="dname" disabled>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <div class="cal-icon">
                                            <input type="text" value="<?php echo @$date;?>" name="date" class="form-control datetimepicker" readonly >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Time</label>
                                        <div class="time-icon">
                                            <input type="text" value="<?php echo @$time;?>" name="time" class="form-control" id="datetimepicker3" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?php echo @$email;?>" name="emailid" type="email" disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Patient Phone Number</label>
                                        <input class="form-control" value="<?php echo @$phone;?>" name="phone" type="text" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Message</label>
                                <textarea cols="30" rows="4" value="" name="msg" class="form-control" readonly><?php echo @$msg;?></textarea>
                            </div>
                            <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="update">Create Appointment</button>
                            </div>
                        </form>
                    </div>
                </div>
