 ...
 while($row = mysqli_fetch_assoc($result)){
    ...
    $dname= $row['dname'];
            /* $_SESSION['dname']=$dname; */
                            ...
                            $n=" ";
    $name=$dname.$n.$dlname; 
    $sql1 ="SELECT AVG (total), 
ROUND (AVG (total),1) AS 'Rounded' 
...
/* $_SESSION['dlname']=$dlname;*/
            	...
            	?>
                          <div class='doctor-img'>
                               ...
                               <a class='avatar' href='#' ><img alt='' src='uploads/<?=$row['dprofile_img']?>'></a>
                    ...
                    /* echo '<a class="dropdown-item" href="edit_appointment.php?aid='.$row["aid"].'"><i class="fa fa-pencil m-r-5"></i> Edit</a>';*/
                           ...
                           echo  '<h4 class="doctor-name text-ellipsis"><a href="patient_docterview.php?dname='.$row["dname"].'">'.$row['dname'].'</a></h4>';
                           echo  "<div class='doc-prof' >".$row['specialization']."</div>";
                           echo "<div class='user-country'>";
                                echo "<i>".$row1['Rounded'].'&nbsp '."out of 5 &nbsp <span class = 'fa fa-star checked' style= 'color:black;'></span></i>";
                           echo "</div>";
                            echo "<div class='user-country'>";
                                echo "<i class='fa fa-map-marker'>".'&nbsp&nbsp' .$row['haddress']."</i>";
                           echo "</div>";
                           echo "</div>";
                           echo "</div>";
...
?>
                   ...
                   <!--  <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="profile.html"><?php echo @$name;?></a></h4>
