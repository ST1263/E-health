            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="AD_login.php">Logout</a>
                    </div>
                </li>
            </ul>
...
/*$demail=$row['emailid'];*/
   ...
   /* $_SESSION['aid']=$aid; */  
      ...
      $msg=$_POST['msg'];
      $status=$_POST['status'];*/
            $sql=mysqli_query($conn,"INSERT INTO prescription(aid,bp,sugar,temprature,prescription) VALUES ('$aid','$bp','$suger','$temprature','$prescription')");
         echo "string";
                 if ( $sql)
                   {
