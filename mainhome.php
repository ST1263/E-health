	...
	<body>
		<!--start-wrap-->
			...
			<div class="header">
				...
				<!--start-logo-->
				<div class="logo">
					<a href="mainhome.php" style="font-size: 30px;">LIFE CARE</a>
				</div>
				<!--end-logo-->
				<!--start-top-nav-->
				<div class="top-nav">
		    ...
		    <div class="content-grids">
				...
				<div class="listview_1_of_3 images_1_of_3">
					...
					<div class="text list_1_of_2">
						  ...
						  <div class="button"><span><a href="Patient_Login.php">Click Here</a></span></div>
				    </div>
				</div>	
				...
				<div class="listview_1_of_3 images_1_of_3">
					...
					<div class="text list_1_of_2">
						  ...
						  <div class="button"><span><a href="AD_Login.php">Click Here</a></span></div>
					</div>
				</div>
