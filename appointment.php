...
if(isset($_SESSION['id']))
{
  ...
  $query = "SELECT * from information where emailid ='$id';";
...
$query = "SELECT * from doctor_profile where emailid = '$emailid'";
...
$fee=$row['fee'];
    ...
    // $fee=$_POST['fee'];
      ...
      $msg=$_POST['msg'];
      $status=$_POST['status'];
            $sql=mysqli_query($conn,"INSERT INTO appointment(dept,dname,aid,pname,date,time,emailid,phone,msg,status,demail,fee) VALUES ('$dept','$dname','$aid','$name','$date','$time','$id','$phone','$msg','$status','$demail','$fee')");
                 ...
                 if ( $sql)
                   {
                      ...
                      echo "'<script> alert('Appointment Booked'); window.location.href='Patient_dashboard.php'; </script>'";
...
<body>
    <div class="main-wrapper">
     ...
     -->                                    <!-- <select class="select">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="dept" id="dept" required="">
                                            <option>Select</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Doctor</label>
                                        <select class="select" name="dname" id="dname" required="">
                                           <option>Select</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label>Message</label>
                                <textarea cols="30" rows="4" name="msg" class="form-control" required=""></textarea>
                            </div>
                            <div class="row">
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="status">
                                            ...
                                            <option value="Under Treatment" disabled>Under Treatment</option>
                                            <option value="Complete" disabled>Complete</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Consentancy Fee</label>
                                    <div class="form-group" id="fee">
                                        
                                        <!-- <select class="select" name="fee" id="fee">
    -->                                        
                                ...
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Consantancy Fee</label>
                                        <input class="form-control " id="fee" value="<?php echo @$fee;?>" name="fee" type="text" readonly>
                                    </div>
                                </div> -->
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="save">Create Appointment</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function loadData1(type1, name1){
    
        $.ajax({
            url : "load.php",
            type : "POST",
            data: {type1 : type1, name1 : name1},
