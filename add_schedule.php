...
if(isset($_POST['add'])){
 ...
 $days = implode(',', $_POST['days']);
      ...
      $status=$_POST['status'];
            $sql=mysqli_query($conn,"INSERT INTO doctor_schedule(dept,dname,start_time,end_time,status,avalable_day) VALUES ('$dept','$dname','$stime','$etime','$status','".$days."')");
                 ...
                 if ( $sql)
                   {
                      ...
                      echo "'<script> alert('Scheduled Added');  </script>'";
     ...
     -->                                    <!-- <select class="select">
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="time-icon">
                                            <input type="text" name="stime" class="form-control" id="datetimepicker3" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="time-icon">
                                            <input type="text" name="etime" class="form-control" id="datetimepicker4" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" multiple="multiple"  name="days[]" required="">
                           ...
                           <!--  <div class="row"> -->
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="add">Add Schedule</button>
                            </div>
                        </form>
                    </div>
                </div>
