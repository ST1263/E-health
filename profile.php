        ...
        <div class="header">
            ...
            <div class="dropdown mobile-user-menu float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="Patient_profile.php">My Profile</a>
                    <a class="dropdown-item" href="Patient_profile.php">Edit Profile</a>
                    <a class="dropdown-item" href="change_password.php">Change Password</a>
                    <a class="dropdown-item" href="logout.php">Logout</a>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0"><span id="fname"></span>  <span id="lname"></span></h3>
                                                <!-- <small class="text-muted">Gynecologist</small> -->
                                                <div class="staff-id"><h5>File No:- <span id="fileno"></span></h5></div>
                            ...
                            <div class="experience-box">
                                <ul class="experience-list">
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Emenrgency Contact Name</a>
                                                <div><a href="#/" class="name"></a><h5><?php echo $ename ?></h5></div>
                                    ...
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                ...
                                                <div><a href="#/" class="name"></a><h5><?php echo $relation ?></h5></div>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Contact number</a>
                                                <div><span class="text"><a href="tel:<?php echo @$ephone;?>"><?php echo $ephone ?></a></span></div>
                                            </div>
                            ...
                            <div class="experience-box">
                                <ul class="experience-list">
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Heaight</a>
                                                <div><a href="#/" class="name"></a><h5><?php echo $height ?></h5></div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                ...
                                                <div><a href="#/" class="name"></a><h5><?php echo $weight ?></h5></div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Marital Status</a>
                                                <div><a href="#/" class="name"></a><h5><?php echo $marital ?></h5></div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
...
<script type="text/javascript">
   ...
   document.getElementById("fname").innerHTML="<?php echo @$fname?>";
      document.getElementById("lname").innerHTML="<?php echo @$lname?>";
      document.getElementById("fileno").innerHTML="<?php echo @$fileno?>";
      ...
      document.getElementById("ename").innerHTML="<?php echo @$ename?>";
      document.getElementById("relation").innerHTML="<?php echo @$relation?>";
      document.getElementById("marital").innerHTML="<?php echo @$marital?>";
      document.getElementById("height").innerHTML="<?php echo @$height?>";
      document.getElementById("ephone").innerHTML="<?php echo @$ephone?>";
      document.getElementById("weight").innerHTML="<?php echo @$weight?>";
